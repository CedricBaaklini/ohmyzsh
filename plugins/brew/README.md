...
| `brinfo` | `brew info`                             | Display information about the given formula.                                               |
...
| `bt`     | `brew tap`                              | List all installed taps or tap a repository by typing the repository link after the alias. |
